"""
CP-Analyzer Default Configuration File
Please copy this file to your working directory and rename it to config.py before running.
Users should modify parameters in config.py according to their needs.
"""
# ... 您的原有 config.py 内容全部粘贴在这里 ...
